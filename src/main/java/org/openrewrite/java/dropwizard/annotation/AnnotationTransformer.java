    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new JavaIsoVisitor<ExecutionContext>() {
            ...
            public J.Annotation visitAnnotation(J.Annotation annotation, ExecutionContext ctx) {
                ...
                JavaTemplate template = JavaTemplate.builder(buildTemplate(attributes)).contextSensitive().javaParser(JavaParser.fromJavaVersion().classpath(JavaParser.runtimeClasspath())).imports(targetAnnotation).build();

                J.Annotation added = template.apply(getCursor(), a.getCoordinates().replace(), targetAnnotation);
            ...
            private boolean isSourceAnnotation(J.Annotation annotation) {
                return annotation.getType() != null && TypeUtils.isOfClassType(annotation.getType(), sourceAnnotation);
            }
